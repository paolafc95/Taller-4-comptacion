...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		.antMatchers("/Games/**").hasAnyRole(AdminType.superAdmin.toString())
		.antMatchers("/Story/**").hasRole(AdminType.admin.toString())
		.antMatchers("/Topics/**").hasRole(AdminType.admin.toString())
